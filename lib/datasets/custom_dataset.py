...
class custom_dataset(imdb):
    ...
    def _load_custom_annotation(self, index):
        ...
        for line in open(filename,'r'):
            ...
            seg_areas[obj_ix] = (x2 - x1 + 1) * (y2 - y1 + 1)
    ...
    def _get_custom_dataset_results_file_template(self):
    ...
    def _write_custom_dataset_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} Custom dataset results file'.format(cls)
            filename = self._get_custom_dataset_results_file_template().format(cls)
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        for i, cls in enumerate(self._classes):
            if cls == '__background__':
                continue
            filename = self._get_custom_dataset_results_file_template().format(cls)
            rec, prec, ap = custom_dataset_eval(
...
if __name__ == '__main__':
    ...
    d = custom_dataset('train', '***Devkit Path***')
    res = d.roidb
